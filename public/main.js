var Example = (function () {
	...
	*/
	...
	$forEach(objectKeys(WellKnownSymbolsStore$1$1), function (name) {
	...
	var defineWellKnownSymbol$1 = function (NAME) {
	  ...
	  if (!has(Symbol, NAME)) defineProperty$c(Symbol, NAME, {
	...
	var setToStringTag$1 = function (it, TAG, STATIC) {
	  if (it && !has(it = STATIC ? it : it.prototype, TO_STRING_TAG$5)) {
	...
	var getInternalState$7 = internalState.getterFor(SYMBOL$1);
	...
	if (!nativeSymbol) {
	  ...
	  if (descriptors) {
	    // https://github.com/tc39/proposal-Symbol-description
	    nativeDefineProperty$2($Symbol$1[PROTOTYPE$4], 'description', {
	      configurable: true,
	      get: function description() {
	...
	// `Array.prototype.reduce` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.reduce
	_export({ target: 'Array', proto: true, forced: !STRICT_METHOD$a || !USES_TO_LENGTH$f }, {
	  reduce: function reduce(callbackfn /* , initialValue */) {
	...
	for (var COLLECTION_NAME$2 in domIterables$1) {
	  ...
	  if (CollectionPrototype$2 && CollectionPrototype$2.forEach !== arrayForEach$1) try {
	    createNonEnumerableProperty(CollectionPrototype$2, 'forEach', arrayForEach$1);
	  } catch (error) {
